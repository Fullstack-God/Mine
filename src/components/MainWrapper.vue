<template>
  <main>
    ...
    <MyButton class="menu-call-btn" @click="showMenu" title="Open Menu">
      <img src="../assets/img/icons/menu.png" class="call-btn-img" alt="open menu">
    </MyButton>
    <MyButton class="scroll-up-btn" @click="scrollToTop" title="Up">
      <img src="../assets/img/icons/toleft.png" class="call-btn-img" alt="to top">
    </MyButton>
...
export default {
  ...
  mounted() {
    window.addEventListener('scroll', function () {
      document.querySelector('.scroll-up-btn').classList.toggle('visible', window.scrollY > 600);
      document.querySelector('.btns-wrapper').classList.toggle('extended', window.scrollY > 600);
    })
  }
}
</script>
